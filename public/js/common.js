	...
	{	
        ...
        dataType:"json",
	        success: function(results)
	        {
	            ...
	            {
	            	$(".pocket").append('<div class="passcard paper" onclick="location.href=\'/map?krlocation='+results[i].mapUrl+"&enlocation="+results[i].location+'\'">'+results[i].location+'<a class="delete" style="color:#fff;"><h1>-</h1></a></div>');
	            	i++;}
